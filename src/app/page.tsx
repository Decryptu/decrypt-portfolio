	...
	return (
		<div className="flex flex-col items-center justify-center w-screen h-screen overflow-hidden bg-gradient-to-tl from-black via-zinc-600/20 to-black">
			...
			<h1
				...
				className="pb-4 z-10 text-6xl sm:text-8xl md:text-9xl text-transparent duration-1000 bg-white cursor-default text-edge-outline animate-title font-display whitespace-nowrap bg-clip-text"
			>
				Decrypt
			</h1>
			...
			<div className="my-16 text-center animate-fade-in">
				<h2 className="text-base mx-8 md:mx-32 lg:mx-80 text-zinc-500 ">
					Hello, I am Decrypt, an independent graphic designer and web designer. I
					currently work with{" "}
					<Link
